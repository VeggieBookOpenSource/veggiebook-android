...
public class MySwitch extends CompoundButton {
    ...
    public MySwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTrackDrawable = a.getDrawable(R.styleable.MySwitch_ntrack);
        ...
        mThumbTextPadding = a.getDimensionPixelSize( R.styleable.MySwitch_nthumbTextPadding, 0);
        mTrackTextPadding = a.getDimensionPixelSize( R.styleable.MySwitch_trackTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize( R.styleable.MySwitch_nswitchMinWidth, 0);
        mSwitchMinHeight = a.getDimensionPixelSize( R.styleable.MySwitch_switchMinHeight, 0);
        mSwitchPadding =  a.getDimensionPixelSize( R.styleable.MySwitch_nswitchPadding, 0);
        ...
        if (mOrientation == VERTICAL) {
        	...
        	if (mPushStyle) {
        		...
        		if (this.getTargetCheckedState() ^ (mTextOnThumb))
        		    mTextPaint.setAlpha((int) (alpha*0.65));
        		else 
